									...
									<tr>
										...
										<td class="report-permissions" colspan="5">
											...
											<span>
												<div aria-checked="false" aria-disabled="false">
													<div class="checkbox">
														@if(in_array("load_card", $all_permission))
														<input type="checkbox" value="1" id="load_card" name="load_card" checked>
														@else
														<input type="checkbox" value="1" id="load_card" name="load_card">
														@endif
														<label for="load_card" class="padding05">{{trans('file.Load Card')}} &nbsp;&nbsp;</label>
													</div>
												</div>
											</span>
											<span>
												<div aria-checked="false" aria-disabled="false">
													<div class="checkbox">
														@if(in_array("fast_recharge", $all_permission))
														<input type="checkbox" value="1" id="fast_recharge" name="fast_recharge" checked>
														@else
														<input type="checkbox" value="1" id="fast_recharge" name="fast_recharge">
														@endif
														<label for="fast_recharge" class="padding05">Fast Recharge &nbsp;&nbsp;</label>
													</div>
												</div>
											</span>
											<span>
