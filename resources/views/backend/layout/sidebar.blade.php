        <ul id="side-main-menu" class="side-menu list-unstyled">
            ...
            <?php
                ...
                $load_card_permission_active = $role_has_permissions_list->where('name', 'load_card')->first();
            ...
            <ul id="sale" class="collapse list-unstyled ">
                ...
                @if($load_card_permission_active)
                <li id="load-card-menu"><a href="{{route('load_cards.index')}}">{{trans('file.Load Card List')}}</a> </li>
                @endif
