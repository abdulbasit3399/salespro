      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-12">
                <h4><strong>{{trans('file.Load Card')}}</strong></h4>
              </div>
              <div class="col-md-12">
                <div class="form-group">
                  <label>Maximum allowable negative balance *</label>
                   
                  <input type="number" name="load_card_negative_balance" class="form-control" value="@if($lims_pos_setting_data){{$lims_pos_setting_data->load_card_negative_balance}}@endif" required />
                </div>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 d-flex justify-content-between">
                ...
                <div class="form-group d-inline">
                  ...
                  <input class="mt-2" type="checkbox" name="options[]" value="load_card" checked>
                  @else
                  <input class="mt-2" type="checkbox" name="options[]" value="load_card">
                  @endif
                  <label class="mt-2"><strong>Load Card</strong></label>
                </div>
